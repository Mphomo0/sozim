...
export default function Footer() {
  return (
    <footer className="bg-slate-950 border-t border-white/5 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-200 h-75 bg-blue-600/10 blur-[120px] pointer-events-none" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-20">
          <div className="space-y-6">
            ...
            <p className="text-slate-400 text-base leading-relaxed font-medium">
              Sozim is an ETDP SETA accredited education and training college in
              Bloemfontein, South Africa. We deliver nationally recognised
              programmes in LIS and ETD since 2009.
            </p>
          </div>

          <div>
            <h3 className="text-white text-lg font-bold mb-8 tracking-tight">
              Quick Links
            </h3>

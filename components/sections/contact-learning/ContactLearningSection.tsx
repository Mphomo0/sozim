      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight text-slate-900 leading-tight">
            Pursue Your Qualifications Through{' '}
            <span className="text-blue-600">Contact Learning</span>
          </h2>
          <p className="mt-6 text-xl text-slate-500 font-medium leading-relaxed">
            Our campus-based programmes offer direct interaction with educators
            and peers, fostering a dynamic learning environment.
          </p>
        </motion.div>
        ...
        >
          <div className="absolute top-0 left-0 w-full h-full bg-linear-to-br from-blue-600/20 to-transparent pointer-events-none" />
          <h3 className="text-3xl md:text-4xl font-extrabold text-white mb-6">
            Ready to start your journey?
          </h3>
          <p className="text-slate-300 text-lg font-medium mb-10 max-w-2xl mx-auto">
            Contact our admissions office today to secure your place in our next
            intake.
          </p>
          <Link
            href="/contact"

...
export default function CourseDetail({ initialCourse }: Props) {
  ...
  const course = (courseData as any)?.data ?? courseData ?? initialCourse

  if (!initialCourse && courseData === undefined && isConvexId)
    return (
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">
            The course you are looking for might have been moved or this link is
            outdated.
          </p>
          <Button asChild>
  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-20">
      ...
      <div className="bg-linear-to-br from-slate-900 tracking-tight via-blue-900 to-sky-900 py-16 relative overflow-hidden mb-12 shadow-md">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <Button
            variant="ghost"
            asChild
            className="mb-8 text-blue-100 hover:text-white hover:bg-white/10 rounded-full px-6 backdrop-blur-md"
          >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 overflow-x-auto pb-4 hide-scrollbar">
          <div className="flex space-x-2 md:space-x-4 min-w-max bg-slate-200/50 rounded-2xl p-2 w-max mx-auto shadow-inner">
                ...
                activeTab === section.key && (
                  ...
                  >
                    <Card className="rounded-3xl shadow-xl hover:shadow-2xl transition-shadow bg-white overflow-hidden border border-slate-200/60">
                      <CardHeader className="bg-linear-to-r from-slate-50 to-slate-100 border-b border-slate-100 py-6">
                          ...
                          {section.modules.map((mod: any, idx: number) => (
                            ...
                            >
                              <div className="flex items-start gap-4">
                                <div className="mt-1 shrink-0 w-8 h-8 rounded-full bg-blue-100 text-blue-600 flex items-center justify-center font-bold text-sm">
                                  {idx + 1}
                                </div>
                              ...
                              <div className="flex items-center gap-3 ml-12 md:ml-0">
                                <Badge
                                  variant="outline"
                                  className="bg-slate-50 text-slate-600 font-medium px-3 py-1.5 rounded-full border-slate-200"
                                >
                                  Level {mod.nqfLevel}
                                </Badge>
                                <Badge
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          <Card className="flex-1 bg-white shadow-xl rounded-3xl border border-slate-200/60 overflow-hidden">
            <CardHeader className="bg-slate-50 border-b border-slate-100 py-6">
              <h2 className="text-2xl font-bold tracking-tight text-slate-900 flex items-center gap-3">
                <CheckCircle className="h-6 w-6 text-green-500" /> Entry
                Requirements
              </h2>
            </CardHeader>
          ...
          <div className="w-full lg:w-1/3">
            <Card className="bg-linear-to-br from-blue-600 to-sky-700 shadow-2xl rounded-3xl text-white relative overflow-hidden h-full flex flex-col justify-center">

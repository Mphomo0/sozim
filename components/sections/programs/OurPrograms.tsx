...
export default function OurPrograms({
  ...
  const loading =
    !initialCourses && (coursesReq === undefined || categoriesReq === undefined)
  const courses = coursesReq ?? initialCourses ?? []
  const categories = categoriesReq ?? initialCategories ?? []
          ...
          <div className="container mx-auto px-4">
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {[1, 2, 3, 4, 5, 6].map((i) => (
                <Card
                  key={i}
                  className="h-full flex flex-col overflow-hidden border border-slate-200/60 bg-white/80 backdrop-blur-sm"
                >
                  ...
                  <CardContent className="flex-1 flex flex-col">
                    ...
                    <div className="mt-auto flex gap-3 pt-6 border-t border-slate-100">
                      <Button
                        className="flex-1 bg-linear-to-r from-blue-600 to-blue-800 text-white rounded-xl h-11"
                        disabled
                      >
                        Apply Now
                      </Button>
          ...
          <div className="container relative z-10 mx-auto px-4">
            <div className="mx-auto max-w-2xl text-center text-white">
              ...
              <p className="mb-10 text-xl font-light text-slate-300 leading-relaxed">
                ...
                program for your career goals. Let&apos;s build your future
                together.
              </p>
            </div>
          </div>
  ...
  return (
    <>
            ...
            <AnimatePresence>
              {filteredCourses.map((course) => {
                ...
                return (
                  ...
                  >
                    <Card className="group h-full flex flex-col overflow-hidden transition-all duration-500 hover:shadow-2xl hover:shadow-blue-500/10 hover:-translate-y-2 border border-slate-200/60 bg-white/80 backdrop-blur-sm relative">
                      <div className="absolute inset-0 bg-linear-to-br from-blue-50/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />
                      ...
                      <CardHeader className="relative z-10 pb-4">
                        <div className="mb-4 flex items-center justify-between text-sm">
                          ...
                          <Badge
                            variant="outline"
                            className="text-slate-600 border-slate-300 rounded-full px-3 py-1"
                          >
                      ...
                      <CardContent className="flex-1 flex flex-col relative z-10">
                        ...
                        <div className="mt-auto flex gap-3 pt-6 border-t border-slate-100">
                          <Link href="/student" className="flex-1">
                            <Button className="w-full bg-linear-to-r from-blue-600 to-blue-800 hover:from-blue-700 hover:to-blue-900 text-white shadow-md hover:shadow-lg transition-all rounded-xl h-11">
                              Apply Now
                            </Button>
                          </Link>
                          ...
                          <Link href={`/courses/${course._id}`}>
                            <Button
                              variant="outline"
                              size="icon"
                              className="h-11 w-11 rounded-xl border-slate-300 hover:border-blue-500 hover:text-blue-600 transition-colors"
                            >
                              <BookOpen
                                className="h-5 w-5"
                                aria-hidden="true"
      ...
      <section className="relative bg-slate-900 py-24 overflow-hidden mt-12">
        ...
        <div className="absolute inset-0 bg-linear-to-t from-slate-950 via-slate-900/90 to-blue-950/80" />
        <div className="container relative z-10 mx-auto px-4">
          <div className="mx-auto max-w-2xl text-center text-white">
            <div className="mx-auto mb-8 flex h-20 w-20 items-center justify-center rounded-2xl bg-linear-to-br from-sky-400 to-blue-600 shadow-[0_0_40px_rgba(56,189,248,0.3)]">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:justify-center">
              <Link href="/contact">
                <Button
                  size="lg"
                  className="h-14 px-8 rounded-full text-lg shadow-lg shadow-blue-500/25 hover:shadow-blue-500/40 hover:-translate-y-1 transition-all duration-300 bg-linear-to-r from-blue-500 to-blue-700 hover:from-blue-600 hover:to-blue-800 border-0 text-white w-full sm:w-auto"
                >
                  Contact an Advisor
                </Button>
              </Link>
              ...
              <Link href="/student">
                <Button
                  size="lg"
                  variant="outline"
                  className="h-14 px-8 rounded-full text-lg bg-white/10 text-white backdrop-blur-md border border-white/20 hover:bg-white/20 hover:-translate-y-1 transition-all duration-300 w-full sm:w-auto"
                >
                  Start Application
                </Button>
              </Link>
